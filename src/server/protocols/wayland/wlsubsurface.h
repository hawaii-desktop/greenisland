...
class WlSubSurface : public QObject, public QWaylandSurfaceInterface, public QtWaylandServer::wl_subsurface
{
public:
    enum Mode {
        Synchronized = 0,
    ...
    inline QWaylandSurfaceItem *viewForOutput(Output *output) const {
...
private:
    ...
    Mode m_mode;
    QPoint m_pos;
    QHash<Output *, QWaylandSurfaceItem *> m_views;

    WlSubSurface *fromSurface(QWaylandSurface *surface);
    WlSubSurface *siblingCheck(QWaylandSurface *surface,
