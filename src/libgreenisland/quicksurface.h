...
class AbstractQuickCompositor;

class GREENISLAND_EXPORT QuickSurface : public Surface
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(QuickSurface)
...
public:
    QuickSurface(wl_client *client, quint32 id, int version, AbstractQuickCompositor *compositor);
    ~QuickSurface();
...
Q_DECLARE_METATYPE(GreenIsland::QuickSurface*)
