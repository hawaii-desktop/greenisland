...
wl_shm_format ShmFormatHelper::fromQImageFormat(QImage::Format format)
{
    Array array = getData();
...
QImage::Format ShmFormatHelper::fromWaylandShmFormat(wl_shm_format format)
{
    Array array = getData();
...
QVector<wl_shm_format> ShmFormatHelper::supportedWaylandFormats()
{
