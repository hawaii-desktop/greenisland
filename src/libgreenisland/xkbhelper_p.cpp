...
int XkbHelper::keysymToQtKey(xkb_keysym_t keysym, Qt::KeyboardModifiers &modifiers, const QString &text)
{
    int code = 0;
...
Qt::KeyboardModifiers XkbHelper::modifiers(struct xkb_state *state)
{
