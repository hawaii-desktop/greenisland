...
class PlasmaSurface : public QObject, public SurfaceInterface, public QtWaylandServer::org_kde_plasma_surface
{
    Q_OBJECT
public:
    PlasmaSurface(PlasmaShell *shell, Surface *surface,
